...
public partial class StartOrchestrationDtoV1
{
    public static string MajorVersion => nameof(StartOrchestrationDtoV1);

    public static int MinorVersion => Descriptor.GetOptions().GetExtension(StartOrchestrationDtoV1Extensions.MinorVersion);
    ...
    public static string GetMajorVersionFromMessage(IReadOnlyDictionary<string, object> messageProperties)
    {
    ...
    public static int GetMinorVersionFromMessage(IReadOnlyDictionary<string, object> messageProperties)
    {
