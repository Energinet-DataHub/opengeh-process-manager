...
/// </summary>
[CollectionDefinition(nameof(ProcessManagerExampleClientCollection))]
public class ProcessManagerExampleClientCollection :
    ICollectionFixture<ProcessManagerExampleClientFixture>
{
}
