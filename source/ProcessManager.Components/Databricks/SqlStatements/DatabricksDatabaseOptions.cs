...
/// <summary>
/// Options for the delta table views in Databricks.
/// </summary>
public class DatabricksDatabaseOptions
{
    public const string SectionName = "Databricks";

    /// <summary>
    /// Name of the database in which the views are located.
    /// </summary>
    [Required]
    public string DatabaseName { get; set; } = "wholesale_results";

    /// <summary>
    /// Name of the catalog in which the views are located.
    /// </summary>
    /// <remarks>
