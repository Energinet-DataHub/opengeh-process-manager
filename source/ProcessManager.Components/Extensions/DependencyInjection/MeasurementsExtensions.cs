...
{
    public static IServiceCollection AddMeasurements(this IServiceCollection serviceCollection)
    {
        serviceCollection.AddTransient<IMeteredDataClient, MeteredDataClient>();
