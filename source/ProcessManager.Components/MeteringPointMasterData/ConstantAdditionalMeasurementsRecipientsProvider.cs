...
public sealed class ConstantAdditionalMeasurementsRecipientsProvider : IAdditionalMeasurementsRecipientsProvider
{
    ...
    {
        { new("570715000000021596"), [Actor.From("5798000020016", "DanishEnergyAgency")] },
        { new("570715000000021732"), [Actor.From("5798000020016", "DanishEnergyAgency")] },
        { new("571313115100000884"), [Actor.From("5798000020016", "DanishEnergyAgency")] },
        { new("571313115100100034"), [Actor.From("5798000020016", "DanishEnergyAgency")] },
        { new("571313115190284409"), [Actor.From("5798000020016", "DanishEnergyAgency")] },
        { new("571313115190284768"), [Actor.From("5798000020016", "DanishEnergyAgency")] },
    };
