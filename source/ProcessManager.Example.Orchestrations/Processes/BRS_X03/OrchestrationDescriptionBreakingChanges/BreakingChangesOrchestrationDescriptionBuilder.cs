...
/// health check test.
/// </summary>
internal class BreakingChangesOrchestrationDescriptionBuilder : IOrchestrationDescriptionBuilder
{
    public static readonly OrchestrationDescriptionUniqueName UniqueName = new(
        name: "BreakingChangesTestDescription",
        version: 1);
    ...
    public OrchestrationDescription Build()
    {
        var description = new OrchestrationDescription(
            ...
            functionName: "BreakingChangesTestDescriptionFunctionNameV1");
