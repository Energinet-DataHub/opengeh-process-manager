...
using Energinet.DataHub.ProcessManager.Orchestrations.Abstractions.Processes.BRS_021.CapacitySettlementCalculation.V1.
    Model;

namespace Energinet.DataHub.ProcessManager.Orchestrations.Abstractions.CustomQueries.Calculations.V1.Model;

public record MissingMeasurementsLogCalculationResultV1
    : OrchestrationInstanceTypedDto,
        ICalculationsQueryResultV1
{
    public MissingMeasurementsLogCalculationResultV1(
        Guid id,
