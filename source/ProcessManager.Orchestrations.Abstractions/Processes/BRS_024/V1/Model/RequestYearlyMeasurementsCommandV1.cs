...
public record RequestYearlyMeasurementsCommandV1(
    ActorIdentityDto OperatingIdentity,
    RequestYearlyMeasurementsInputV1 InputParameter,
    string IdempotencyKey) :
    StartOrchestrationInstanceMessageCommand<RequestYearlyMeasurementsInputV1>(
        OperatingIdentity,
        new OrchestrationDescriptionUniqueNameDto(Brs_024.Name, 1),
        InputParameter,
        IdempotencyKey,
