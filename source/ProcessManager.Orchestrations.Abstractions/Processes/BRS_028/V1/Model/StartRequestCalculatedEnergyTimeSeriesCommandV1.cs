...
namespace Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_028.V1.Model;
    ...
    : MessageCommand<RequestCalculatedWholesaleServicesInputV1>
{
    ...
    public RequestCalculatedWholesaleServicesCommandV1(
        ActorIdentityDto operatingIdentity,
        RequestCalculatedWholesaleServicesInputV1 inputParameter,
        string messageId)
            : base(
                operatingIdentity,
