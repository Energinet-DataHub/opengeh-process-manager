...
/// with EDI, which uses the <see cref="EnqueueMissingMeasurementsLogOnDemandHttpV1.RouteName"/> as the HTTP URI.
/// <remarks>
...
public record EnqueueMissingMeasurementsLogOnDemandHttpV1(
    Guid OrchestrationInstanceId,
    IReadOnlyCollection<EnqueueMissingMeasurementsLogOnDemandHttpV1.DateWithMeteringPointId> Data)
    : IEnqueueDataSyncDto
{
