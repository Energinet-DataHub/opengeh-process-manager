...
/// <summary>
/// This is a copy of the existing <see cref="TerminateForwardMeteredDataHandlerV1Tests"/>, to test the "old"
...
/// </summary>
public class TerminateForwardMeteredDataHandlerV1OldTests
    : IClassFixture<ProcessManagerDatabaseFixture>, IAsyncLifetime
{
    ...
    public TerminateForwardMeteredDataHandlerV1OldTests(ProcessManagerDatabaseFixture fixture)
    {
        _fixture = fixture;
