...
public class MonitorOrchestrationUsingClientsScenario : IAsyncLifetime
{
    ...
    private static ForwardMeteredDataInputV1 CreateForwardMeteredDataInputV1()
    {
        var input = new ForwardMeteredDataInputV1(
            ...
            MeteredData:
            [
                new("1", DateTimeOffset.Parse("2024-12-01T23:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("2", DateTimeOffset.Parse("2024-12-02T00:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("3", DateTimeOffset.Parse("2024-12-02T01:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("4", DateTimeOffset.Parse("2024-12-02T02:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("5", DateTimeOffset.Parse("2024-12-02T03:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("6", DateTimeOffset.Parse("2024-12-02T04:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("7", DateTimeOffset.Parse("2024-12-02T05:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("8", DateTimeOffset.Parse("2024-12-02T06:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("9", DateTimeOffset.Parse("2024-12-02T07:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("10", DateTimeOffset.Parse("2024-12-02T08:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("11", DateTimeOffset.Parse("2024-12-02T09:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("12", DateTimeOffset.Parse("2024-12-02T10:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("13", DateTimeOffset.Parse("2024-12-02T11:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("14", DateTimeOffset.Parse("2024-12-02T12:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("15", DateTimeOffset.Parse("2024-12-02T13:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("16", DateTimeOffset.Parse("2024-12-02T14:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("17", DateTimeOffset.Parse("2024-12-02T15:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("18", DateTimeOffset.Parse("2024-12-02T16:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("19", DateTimeOffset.Parse("2024-12-02T17:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("20", DateTimeOffset.Parse("2024-12-02T18:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("21", DateTimeOffset.Parse("2024-12-02T19:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("22", DateTimeOffset.Parse("2024-12-02T20:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("23", DateTimeOffset.Parse("2024-12-02T21:00:00Z"), "112.000", Quality.AsProvided.Name),
                new("24", DateTimeOffset.Parse("2024-12-02T22:00:00Z"), "112.000", Quality.AsProvided.Name),
            ]);
        return input;
    }
}
