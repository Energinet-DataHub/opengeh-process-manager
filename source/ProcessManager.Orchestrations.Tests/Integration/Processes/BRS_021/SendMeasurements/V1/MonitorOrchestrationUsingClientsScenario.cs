...
using Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_021.SendMeasurements.V1.Triggers;
...
namespace Energinet.DataHub.ProcessManager.Orchestrations.Tests.Integration.Processes.BRS_021.SendMeasurements.V1;
...
public class MonitorOrchestrationUsingClientsScenario : IAsyncLifetime
{
        ...
        ITestOutputHelper testOutputHelper)
    {
        ...
        services.AddInMemoryConfiguration(new Dictionary<string, string?>
        {
            ...
            [$"{ProcessManagerServiceBusClientOptions.SectionName}:{nameof(ProcessManagerServiceBusClientOptions.Brs021ForwardMeteredDataStartTopicName)}"]
                = _fixture.OrchestrationsAppManager.Brs021SendMeasurementsStartTopic.Name,
            [$"{ProcessManagerServiceBusClientOptions.SectionName}:{nameof(ProcessManagerServiceBusClientOptions.Brs021ForwardMeteredDataNotifyTopicName)}"]
                = _fixture.OrchestrationsAppManager.Brs021SendMeasurementsNotifyTopic.Name,
        });
    ...
    public Task InitializeAsync()
    {
        ...
        _fixture.EnqueueBrs021SendMeasurementsServiceBusListener.ResetMessageHandlersAndReceivedMessages();
        ...
        Given_ValidSendMeasurementsInputV1_When_Started_Then_OrchestrationInstanceTerminatesWithSuccess()
    {
        ...
        var (isWaitingForMeasurementsNotify, orchestrationInstance) = await processManagerClient
            .WaitForStepToBeRunning<SendMeasurementsInputV1>(
        ...
        await _fixture.EnqueueBrs021SendMeasurementsServiceBusListener.WaitOnEnqueueMessagesInEdiAndMockNotifyToProcessManager(
        ...
        var (orchestrationTerminatedWithSucceeded, terminatedOrchestrationInstance) = await processManagerClient
            .WaitForOrchestrationInstanceTerminated<SendMeasurementsInputV1>(
        ...
        var expectedCustomStateV1 = new SendMeasurementsCustomState(
            HistoricalMeteringPointMasterData:
            [
                SendMeasurementsCustomState.MasterData.FromMeteringPointMasterData(meteringPointMasterData)
            ]);
    ...
    public async Task Given_InvalidSendMeasurementsInputV1_When_Started_Then_OrchestrationInstanceTerminatesWithFailed_AndThen_BusinessValidationStepFailed()
    {
        ...
        var verifyEnqueueRejectedActorMessagesEvent = await _fixture.EnqueueBrs021SendMeasurementsServiceBusListener.When(
                (message) =>
                {
        ...
        await processManagerMessageClient.NotifyOrchestrationInstanceAsync(
            new SendMeasurementsNotifyEventV1(
                OrchestrationInstanceId: orchestrationInstance!.Id.ToString()),
        ...
        terminatedOrchestrationInstance.CustomState.Should()
            .BeEquivalentTo(JsonSerializer.Serialize(new SendMeasurementsCustomState([])));
