        ...
        var inputV1 = new SendMeasurementsInputV1Builder()
            ...
            .WithMeteredData(
                Enumerable.Range(1, 6)
                    .Select(
                        i => new SendMeasurementsInputV1.MeteredData(i.ToString(), "1024", Quality.AsProvided.Name))
                    .ToList())
            .Build();
    ...
    public async Task Given_MissingPosition_When_Validate_Then_PositionsNotConsecutiveError()
    {
        var inputV1 = new SendMeasurementsInputV1Builder()
            ...
            [
                ...
                new SendMeasurementsInputV1.MeteredData("11", "1024", Quality.AsProvided.Name)
            ])
            .Build();
                ...
                .. Enumerable.Range(1, 9)
                    .Select(
                        i => new SendMeasurementsInputV1.MeteredData(
                            ...
                            "1024",
                            Quality.AsProvided.Name)),
                new SendMeasurementsInputV1.MeteredData("9", "1024", Quality.AsProvided.Name)
            ])
            .Build();
