...
public class Brs021_ForwardMeteredData_MasterData_BusinessValidationDtoValidatorTests
{
    private readonly BusinessValidator<Brs021_ForwardMeteredData_MasterData_BusinessValidationDto> _sut;

    public Brs021_ForwardMeteredData_MasterData_BusinessValidationDtoValidatorTests()
    {
        ...
        var orchestrationsAbstractionsAssembly =
            typeof(Brs021_ForwardMeteredData_MasterData_BusinessValidationDto).Assembly;
        ...
        _sut = serviceProvider
            .GetRequiredService<BusinessValidator<Brs021_ForwardMeteredData_MasterData_BusinessValidationDto>>();
    }
