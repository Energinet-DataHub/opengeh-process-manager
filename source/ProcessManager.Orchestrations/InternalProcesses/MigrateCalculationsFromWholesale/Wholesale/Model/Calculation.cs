...
public class Calculation
{
    ...
    /// Throws a <see cref="InvalidOperationException"/> if the state transition is invalid.
    /// </summary>
    ...
    {
        throw new InvalidOperationException($"Cannot change {nameof(CalculationExecutionState)} from {currentState} to {desiredState}");
    }
    ...
    {
        throw new InvalidOperationException($"Cannot change {nameof(CalculationOrchestrationState)} from {currentState} to {desiredState}");
    }
}
