...
namespace Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_021.CapacitySettlementCalculation.V1.Activities.EnqueueActorMessagesStep;

public class EnqueueActorMessageActivity_Brs_021_CapacitySettlementCalculation_V1(
    ILogger<EnqueueActorMessageActivity_Brs_021_CapacitySettlementCalculation_V1> logger,
...
{
    private readonly ILogger<EnqueueActorMessageActivity_Brs_021_CapacitySettlementCalculation_V1> _logger = logger;
    ...
    private readonly DatabricksQueryOptions _databricksQueryOptions = databricksQueryOptions.Get(QueryOptionsSectionNames.CapacitySettlementQuery);
    ...
    [Function(nameof(EnqueueActorMessageActivity_Brs_021_CapacitySettlementCalculation_V1))]
