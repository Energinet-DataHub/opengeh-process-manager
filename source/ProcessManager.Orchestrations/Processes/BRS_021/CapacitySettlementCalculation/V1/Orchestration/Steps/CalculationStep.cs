...
using Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_021.CapacitySettlementCalculation.V1.Activities.CalculationStep;
...
namespace Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_021.CapacitySettlementCalculation.V1.Orchestration.Steps;
    ...
    protected override async Task<OrchestrationStepTerminationState> OnExecuteAsync()
    {
        ...
        while (Context.CurrentUtcDateTime < expiryTime)
        {
            ...
            var jobRunStatus = await Context.CallActivityAsync<JobRunStatus>(
                nameof(CalculationStepGetJobRunStatusActivity_Brs_021_CapacitySettlementCalculation_V1),
                new CalculationStepGetJobRunStatusActivity_Brs_021_CapacitySettlementCalculation_V1.ActivityInput(
                    jobRunId),
                DefaultRetryOptions);
