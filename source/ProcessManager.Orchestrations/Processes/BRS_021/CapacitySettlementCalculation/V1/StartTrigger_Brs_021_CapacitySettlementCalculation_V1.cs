...
internal class StartTrigger_Brs_021_CapacitySettlementCalculation_V1(
    StartCalculationHandlerV1 handler)
{
    /// <summary>
    /// Start a BRS-021_CapacitySettlementCalculation calculation and return its id.
    /// </summary>
    [Function(nameof(StartTrigger_Brs_021_CapacitySettlementCalculation_V1))]
    [Authorize]
