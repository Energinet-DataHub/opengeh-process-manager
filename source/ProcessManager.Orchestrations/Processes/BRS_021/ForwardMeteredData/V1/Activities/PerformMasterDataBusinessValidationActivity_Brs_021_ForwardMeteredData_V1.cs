...
internal class PerformMasterDataBusinessValidationActivity_Brs_021_ForwardMeteredData_V1(
    IOrchestrationInstanceProgressRepository repository,
    BusinessValidator<Brs021_ForwardMeteredData_MasterData_BusinessValidationDto> validator)
{
    private readonly IOrchestrationInstanceProgressRepository _repository = repository;

    private readonly BusinessValidator<Brs021_ForwardMeteredData_MasterData_BusinessValidationDto> _validator =
        validator;

    [Function(nameof(PerformMasterDataBusinessValidationActivity_Brs_021_ForwardMeteredData_V1))]
