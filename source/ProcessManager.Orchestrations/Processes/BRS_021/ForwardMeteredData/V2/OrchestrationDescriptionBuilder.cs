...
namespace Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_021.ForwardMeteredData.V2;
...
internal class OrchestrationDescriptionBuilder : IOrchestrationDescriptionBuilder
{
    ...
    public static readonly OrchestrationDescriptionUniqueNameDto UniqueName = new OrchestrationDescriptionUniqueNameDto("Brs_021_ForwardMeteredData", 2);
