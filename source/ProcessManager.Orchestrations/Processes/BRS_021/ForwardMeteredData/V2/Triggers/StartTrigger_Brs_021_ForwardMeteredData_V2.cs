...
public class StartTrigger_Brs_021_ForwardMeteredData_V2(
    StartForwardMeteredDataHandlerV2 handler)
{
    private readonly StartForwardMeteredDataHandlerV2 _handler = handler;

    /// <summary>
    /// Start a BRS-021 ForwardMeteredData.
    /// </summary>
    [Function(nameof(StartTrigger_Brs_021_ForwardMeteredData_V2))]
