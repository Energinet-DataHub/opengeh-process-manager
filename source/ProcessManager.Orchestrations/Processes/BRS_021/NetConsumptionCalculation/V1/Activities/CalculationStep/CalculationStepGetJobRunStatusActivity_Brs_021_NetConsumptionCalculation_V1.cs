...
namespace Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_021.NetConsumptionCalculation.V1.Activities.CalculationStep;

internal class CalculationStepGetJobRunStatusActivity_Brs_021_NetConsumptionCalculation_V1(
    [FromKeyedServices(DatabricksWorkspaceNames.Measurements)] IDatabricksJobsClient client)
{
    ...
    [Function(nameof(CalculationStepGetJobRunStatusActivity_Brs_021_NetConsumptionCalculation_V1))]
