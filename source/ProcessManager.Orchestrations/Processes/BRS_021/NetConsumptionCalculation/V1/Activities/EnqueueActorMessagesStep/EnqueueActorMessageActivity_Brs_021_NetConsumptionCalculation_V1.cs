...
namespace Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_021.NetConsumptionCalculation.V1.Activities.EnqueueActorMessagesStep;

public class EnqueueActorMessageActivity_Brs_021_NetConsumptionCalculation_V1(
    ILogger<EnqueueActorMessageActivity_Brs_021_NetConsumptionCalculation_V1> logger,
...
{
    private readonly ILogger<EnqueueActorMessageActivity_Brs_021_NetConsumptionCalculation_V1> _logger = logger;
    ...
    private readonly DatabricksQueryOptions _databricksQueryOptions = databricksQueryOptions.Get(QueryOptionsSectionNames.NetConsumptionQuery);
    ...
    [Function(nameof(EnqueueActorMessageActivity_Brs_021_NetConsumptionCalculation_V1))]
