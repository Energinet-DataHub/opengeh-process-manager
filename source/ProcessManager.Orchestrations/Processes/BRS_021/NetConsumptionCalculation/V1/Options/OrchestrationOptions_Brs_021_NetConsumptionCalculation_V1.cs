...
using Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_021.NetConsumptionCalculation.V1.Orchestration;

namespace Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_021.NetConsumptionCalculation.V1.Options;

/// <summary>
/// Options for the <see cref="Orchestration_Brs_021_NetConsumptionCalculation_V1"/>.
/// </summary>
public class OrchestrationOptions_Brs_021_NetConsumptionCalculation_V1
{
    public const string SectionName = "Orchestration_Brs_021_NetConsumptionCalculation_V1";
