...
using Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_021.NetConsumptionCalculation.V1.Activities;
using Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_021.NetConsumptionCalculation.V1.Model;
using
    Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_021.NetConsumptionCalculation.V1.Orchestration.Steps;
...
internal class Orchestration_Brs_021_NetConsumptionCalculation_V1
{
    public static readonly OrchestrationDescriptionUniqueNameDto UniqueName = Brs_021_NetConsumptionCalculation.V1;
    ...
    public Orchestration_Brs_021_NetConsumptionCalculation_V1(IFeatureFlagManager featureFlagManager)
    {
    ...
    [Function(nameof(Orchestration_Brs_021_NetConsumptionCalculation_V1))]
        ...
        [OrchestrationTrigger] TaskOrchestrationContext context)
    {
        ...
        if (await _featureFlagManager.IsEnabledAsync(FeatureFlag.EnableBrs021NetConsumptionEnqueueMessages))
        {
    ...
    private async Task<OrchestrationInstanceContext> InitializeOrchestrationAsync(TaskOrchestrationContext context)
    {
        ...
        var instanceContext = await context.CallActivityAsync<OrchestrationInstanceContext>(
            nameof(GetOrchestrationInstanceContextActivity_Brs_021_NetConsumptionCalculation_V1),
            new GetOrchestrationInstanceContextActivity_Brs_021_NetConsumptionCalculation_V1.ActivityInput(
                instanceId),
            _defaultTaskOptions);
