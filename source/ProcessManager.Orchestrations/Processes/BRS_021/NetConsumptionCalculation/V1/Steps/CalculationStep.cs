...
using Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_021.NetConsumptionCalculation.V1.Activities.CalculationStep;
...
namespace Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_021.NetConsumptionCalculation.V1.Steps;
            ...
            orchestrationInstanceContext.OrchestrationInstanceId)
{
    ...
    protected override async Task<OrchestrationStepTerminationState> OnExecuteAsync()
    {
        ...
        var jobRunId = await Context.CallActivityAsync<JobRunId>(
            nameof(CalculationStepStartJobActivity_Brs_021_NetConsumptionCalculation_V1),
            new CalculationStepStartJobActivity_Brs_021_NetConsumptionCalculation_V1.ActivityInput(
                orchestrationInstanceContext.OrchestrationInstanceId),
            DefaultRetryOptions);
        ...
        while (Context.CurrentUtcDateTime < expiryTime)
        {
            ...
            var jobRunStatus = await Context.CallActivityAsync<JobRunStatus>(
                nameof(CalculationStepGetJobRunStatusActivity_Brs_021_NetConsumptionCalculation_V1),
                new CalculationStepGetJobRunStatusActivity_Brs_021_NetConsumptionCalculation_V1.ActivityInput(
                    jobRunId),
                DefaultRetryOptions);
