...
namespace Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_024.V1.Orchestration.Steps;

internal class AuthorizationStep(
    ...
    OrchestrationInstanceId instanceId)
        ...
        instanceId)
{
    internal const string StepDescription = "Authorization";
    ...
    {
        var authorizationResult = await Context.CallActivityAsync<PerformAuthorizationActivity_Brs_024_V1.ActivityOutput>(
            nameof(PerformAuthorizationActivity_Brs_024_V1),
            new PerformAuthorizationActivity_Brs_024_V1.ActivityInput(
                InstanceId,
                StepSequence),
            DefaultRetryOptions);

        var asyncAuthorizationTerminationState = authorizationResult.IsAuthorized
