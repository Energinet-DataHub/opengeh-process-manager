        ...
        instanceId)
{
    ...
    {
        var validationResult = await Context.CallActivityAsync<PerformBusinessValidationActivity_Brs_024_V1.ActivityOutput>(
            nameof(PerformBusinessValidationActivity_Brs_024_V1),
            new PerformBusinessValidationActivity_Brs_024_V1.ActivityInput(
                InstanceId,
                StepSequence),
            DefaultRetryOptions);
