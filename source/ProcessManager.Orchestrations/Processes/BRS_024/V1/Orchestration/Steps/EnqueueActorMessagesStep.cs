...
internal class EnqueueActorMessagesStep(
    ...
    PerformBusinessValidationActivity_Brs_024_V1.ActivityOutput validationResult,
    ...
    protected override async Task<StepInstanceTerminationState> OnExecuteAsync()
    {
        ...
        if (validationResult.IsValid)
        {
            await Context.CallActivityAsync(
                nameof(EnqueueActorMessagesActivity_Brs_024_V1),
                new EnqueueActorMessagesActivity_Brs_024_V1.ActivityInput(
                    InstanceId,
                    idempotencyKey),
                DefaultRetryOptions);
        }
        ...
        await Context.WaitForExternalEvent<int?>(
            eventName: RequestYearlyMeasurementsNotifyEventV1.OrchestrationInstanceEventName,
