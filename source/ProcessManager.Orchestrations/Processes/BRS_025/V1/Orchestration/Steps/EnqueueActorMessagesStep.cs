...
internal class EnqueueActorMessagesStep(
    ...
    PerformBusinessValidationActivity_Brs_025_V1.ActivityOutput validationResult,
    ...
    protected override async Task<StepInstanceTerminationState> OnExecuteAsync()
    {
        ...
        if (validationResult.IsValid)
        {
            await Context.CallActivityAsync(
                nameof(EnqueueActorMessagesActivity_Brs_025_V1),
                new EnqueueActorMessagesActivity_Brs_025_V1.ActivityInput(
                    InstanceId,
                    idempotencyKey),
                DefaultRetryOptions);
        }
        else
        {
            ...
            await Context.CallActivityAsync(
                nameof(EnqueueRejectMessageActivity_Brs_025_V1),
                new EnqueueRejectMessageActivity_Brs_025_V1.ActivityInput(
                    InstanceId,
        ...
        await Context.WaitForExternalEvent<int?>(
            eventName: RequestMeasurementsNotifyEventV1.OrchestrationInstanceEventName,
