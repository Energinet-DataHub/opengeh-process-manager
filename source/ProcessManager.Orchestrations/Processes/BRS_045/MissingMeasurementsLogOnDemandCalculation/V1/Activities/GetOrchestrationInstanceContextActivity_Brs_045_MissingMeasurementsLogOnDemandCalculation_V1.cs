...
namespace Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_045.MissingMeasurementsLogOnDemandCalculation.V1.Activities;

/// <summary>
/// Get the <see cref="OrchestrationInstanceContext"/> for the orchestration instance.
/// </summary>
internal class GetOrchestrationInstanceContextActivity_Brs_045_MissingMeasurementsLogOnDemandCalculation_V1(
    IOptions<OrchestrationOptions_Brs_045_MissingMeasurementsLogOnDemandCalculation_V1> orchestrationOptions)
{
    private readonly OrchestrationOptions_Brs_045_MissingMeasurementsLogOnDemandCalculation_V1 _orchestrationOptions = orchestrationOptions.Value;

    [Function(nameof(GetOrchestrationInstanceContextActivity_Brs_045_MissingMeasurementsLogOnDemandCalculation_V1))]
