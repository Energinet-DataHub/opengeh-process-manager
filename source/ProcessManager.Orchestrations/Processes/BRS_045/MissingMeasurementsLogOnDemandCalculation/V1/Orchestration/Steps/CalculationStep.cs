...
namespace Energinet.DataHub.ProcessManager.Orchestrations.Processes.BRS_045.MissingMeasurementsLogOnDemandCalculation.V1.Orchestration.Steps;
            ...
            orchestrationInstanceContext.OrchestrationInstanceId)
{
    ...
    protected override async Task<StepInstanceTerminationState> OnExecuteAsync()
    {
        ...
        var jobRunId = await Context.CallActivityAsync<JobRunId>(
            nameof(CalculationStepStartJobActivity_Brs_045_MissingMeasurementsLogOnDemandCalculation_V1),
        ...
        while (Context.CurrentUtcDateTime < expiryTime)
        {
            ...
            var jobRunStatus = await Context.CallActivityAsync<JobRunStatus>(
                nameof(CalculationStepGetJobRunStatusActivity_Brs_045_MissingMeasurementsLogOnDemandCalculation_V1),
                new CalculationStepGetJobRunStatusActivity_Brs_045_MissingMeasurementsLogOnDemandCalculation_V1.ActivityInput(
                    jobRunId),
                DefaultRetryOptions);
