...
/// </summary>
[CollectionDefinition(nameof(ProcessManagerExampleApiCollection))]
public class ProcessManagerExampleApiCollection :
    ICollectionFixture<ProcessManagerExampleApiFixture>
{
}
