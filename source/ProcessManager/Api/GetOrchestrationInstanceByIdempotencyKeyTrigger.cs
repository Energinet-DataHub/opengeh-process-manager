...
internal class GetOrchestrationInstanceByIdempotencyKeyTrigger(
    ILogger<GetOrchestrationInstanceByIdempotencyKeyTrigger> logger,
    IOrchestrationInstanceQueries queries)
{
    ...
    /// <summary>
    /// Get orchestration instance by idempotency key.
    /// </summary>
    [Function(nameof(GetOrchestrationInstanceByIdempotencyKeyTrigger))]
    [Authorize]
    public async Task<IActionResult> Run(
        [HttpTrigger(
            AuthorizationLevel.Anonymous,
            "post",
            Route = "orchestrationinstance/query/idempotencykey")]
